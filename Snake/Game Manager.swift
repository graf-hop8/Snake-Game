...
//  Snake
//
//  Created by Grafton Hopkins on 2019-07-19.
//  Copyright © 2019 Grafton Hopkins. All rights reserved.
//
...
class GameManager {
    ...
    private func generateNewPoint() {
        var randomX = CGFloat(arc4random_uniform(25))
        var randomY = CGFloat(arc4random_uniform(45))
